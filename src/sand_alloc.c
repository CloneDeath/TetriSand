...
#define BLOCK_MEM( ptr ) ( void * )( (void*)ptr + sizeof( block ) )
#define BLOCK_HEADER( ptr ) ( void * )( (void*)ptr - sizeof( block ) )
 ...
 * begin address, this helps when scanning continuous blocks
 */
 ...
 * can be coalesced and also checks if our last free block
 * ends where the program break is. If it does, and the free
 * block is larger than MIN_DEALLOC then the block is released
